...
function App() {
  ...
  return (
    <div>
      <Router>
        <Navbar bg="dark" variant="dark" expand="lg">
          <Navbar.Brand href="/">高校录取分数线</Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              <Link class="nav-link" to="/home">主页</Link>
              <Link class="nav-link" to="/data">看数据</Link>
              <Link class="nav-link" to="/institute">查学校</Link>
              <Link class="nav-link" to="/forum">讨论区</Link>
              <Link class="nav-link" to="/about">关于</Link>
            </Nav>
            <Form inline style={{ marginRight: 8 }}>
              <FormControl type="text" placeholder="..." className="mr-sm-2" />
              <Button variant="outline-success">搜索</Button>
        ...
        <div className="container" style={{ padding: "1em" }}>
          <Switch>
            ...
            <Route path="/institute">
              <Institute path={[{ name: '查学校', url: '/institute' }]} setPath={setPath} />
            </Route>
